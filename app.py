...
Como rodar este código no seu computador (Gratuitamente)
1. Instale o Python: Baixe e instale do python.org.
2. Abra o Terminal (Prompt de Comando).
3. Instale as bibliotecas necessárias:
pip install streamlit pandas

4. Salve o código: Copie o código acima e cole num bloco de notas. Salve como app.py numa pasta.
5. Execute: No terminal, navegue até a pasta e digite:
